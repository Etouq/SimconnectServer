...
void SimconnectInterface::handlePfdData(SIMCONNECT_RECV_SIMOBJECT_DATA *pObjData)
{
    ...
    if (d_lastPfdData.total_air_temp != newData.total_air_temp)
    {
