...
void SimconnectThread::handlePropSingleEngdata(SIMCONNECT_RECV_SIMOBJECT_DATA *pObjData)
{
    ...
    //rpm
    if (fabs(d_lastPropData.engine1Rpm - newData->engine1Rpm) >= d_currentAirplaneSettings.rpmEpsilon)
    {
    ...
    //second
    if (fabs(d_lastPropData.engine1Second - newData->engine1Second) >= d_currentAirplaneSettings.secondEpsilon)
    {
    ...
    {
        if(fabs(d_lastPropData.commonData.fuelQtyTotal - newData->commonData.fuelQtyTotal) >= d_currentAirplaneSettings.fuelQtyEpsilon)
        {
    ...
    {
        if(fabs(d_lastPropData.commonData.fuelQtyLeft - newData->commonData.fuelQtyLeft) >= d_currentAirplaneSettings.fuelQtyEpsilon)
        {
        ...
        if(fabs(d_lastPropData.commonData.fuelQtyRight - newData->commonData.fuelQtyRight) >= d_currentAirplaneSettings.fuelQtyEpsilon)
        {
    ...
    //fuel flow
    if(fabs(d_lastPropData.commonData.engine1FuelFlow - newData->commonData.engine1FuelFlow) >= d_currentAirplaneSettings.fuelFlowEpsilon)
    {
    ...
    //oil temp
    if(fabs(d_lastPropData.commonData.engine1OilTemp - newData->commonData.engine1OilTemp) >= d_currentAirplaneSettings.oilTempEpsilon)
    {
    ...
    //oil press
    if(fabs(d_lastPropData.commonData.engine1OilPress - newData->commonData.engine1OilPress) >= d_currentAirplaneSettings.oilPressEpsilon)
    {
    ...
    if (d_currentAirplaneSettings.hasEgt)
        if (fabs(d_lastPropData.engine1Egt - newData->engine1Egt) >= d_currentAirplaneSettings.egtEpsilon)
        {
...
void SimconnectThread::handlePropTwinEngdata(SIMCONNECT_RECV_SIMOBJECT_DATA *pObjData)
{
    ...
    if (fabs(d_lastPropData.engine2Rpm - newData->engine2Rpm) >= d_currentAirplaneSettings.rpmEpsilon)
    {
    ...
    if (fabs(d_lastPropData.engine2Second - newData->engine2Second) >= d_currentAirplaneSettings.secondEpsilon)
    {
    ...
    if(fabs(d_lastPropData.commonData.engine2FuelFlow - newData->commonData.engine2FuelFlow) >= d_currentAirplaneSettings.fuelFlowEpsilon)
    {
    ...
    if(fabs(d_lastPropData.commonData.engine2OilTemp - newData->commonData.engine2OilTemp) >= d_currentAirplaneSettings.oilTempEpsilon)
    {
    ...
    if(fabs(d_lastPropData.commonData.engine2OilPress - newData->commonData.engine2OilPress) >= d_currentAirplaneSettings.oilPressEpsilon)
    {
    ...
    if (d_currentAirplaneSettings.hasEgt)
    {
        ...
        if (fabs(d_lastPropData.engine2Egt - newData->engine2Egt) >= d_currentAirplaneSettings.egtEpsilon)
        {
