...
void SimconnectThread::handleRadioData(const PfdRadioStruct &newData)
{
    ...
    if (fabs(d_lastRadioData.com1_stby - newData.com1_stby) >= 0.001)
    {
        ...
        dataToSend.append(reinterpret_cast<const char *>(&id), sizeof(id));
        dataToSend.append(reinterpret_cast<const char *>(&newData.com1_stby), sizeof(newData.com1_stby));
    }
    if (fabs(d_lastRadioData.com2_stby - newData.com2_stby) >= 0.001)
    {
        ...
        dataToSend.append(reinterpret_cast<const char *>(&id), sizeof(id));
        dataToSend.append(reinterpret_cast<const char *>(&newData.com2_stby), sizeof(newData.com2_stby));
    }
    ...
    if (fabs(d_lastRadioData.nav1_stby - newData.nav1_stby) >= 0.009)
    {
        ...
        dataToSend.append(reinterpret_cast<const char *>(&id), sizeof(id));
        dataToSend.append(reinterpret_cast<const char *>(&newData.nav1_stby), sizeof(newData.nav1_stby));
    }
    if (fabs(d_lastRadioData.nav2_stby - newData.nav2_stby) >= 0.009)
    {
        ...
        dataToSend.append(reinterpret_cast<const char *>(&id), sizeof(id));
        dataToSend.append(reinterpret_cast<const char *>(&newData.nav2_stby), sizeof(newData.nav2_stby));
    }
    ...
    if (d_lastRadioData.xpdr_code != newData.xpdr_code)
    {
        ...
        dataToSend.append(reinterpret_cast<const char *>(&id), sizeof(id));
        dataToSend.append(reinterpret_cast<const char *>(&newData.xpdr_code), sizeof(newData.xpdr_code));
    }
    ...
    if (d_lastRadioData.xpdr_state != newData.xpdr_state)
    {
        ...
        dataToSend.append(reinterpret_cast<const char *>(&id), sizeof(id));
        dataToSend.append(reinterpret_cast<const char *>(&newData.xpdr_state), sizeof(newData.xpdr_state));
    }
