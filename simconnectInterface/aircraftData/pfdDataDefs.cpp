...
PfdWindStruct::PfdWindStruct(PfdWindRawStruct *data)
{
    ...
    wind_direction = fmod(360.0 + fmod(data->ambient_wind_direction + 180.0 - data->rotation, 360.0), 360.0);
}
...
const vector<dataDef> pfdWindDefs = {
    { "PLANE HEADING DEGREES MAGNETIC", "degree", SIMCONNECT_DATATYPE_FLOAT64, 0.05 },
    { "AMBIENT WIND VELOCITY", "knots", SIMCONNECT_DATATYPE_FLOAT64, 0.05 },
    { "AMBIENT WIND DIRECTION", "degree", SIMCONNECT_DATATYPE_FLOAT64, 0.05 }
};
