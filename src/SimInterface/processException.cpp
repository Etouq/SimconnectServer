...
void SimInterface::processException(DWORD exceptionId)
{
    switch (exceptionId)
    {
        ...
        case SIMCONNECT_EXCEPTION_ERROR:
            emit receivedError("An unspecific error has occurred. This can be from incorrect flag "
        ...
        case SIMCONNECT_EXCEPTION_UNOPENED:
            emit receivedError("Specifies that communication with the SimConnect server has not been "
                               "opened. This error is not currently used.");
            break;
        case SIMCONNECT_EXCEPTION_VERSION_MISMATCH:
            emit receivedError("Specifies a versioning error has occurred. Typically this will occur "
        ...
        case SIMCONNECT_EXCEPTION_EVENT_ID_DUPLICATE:
            emit receivedError("Specifies that the event ID has been used already. This can occur with "
        ...
        case SIMCONNECT_EXCEPTION_INVALID_DATA_SIZE:
            emit receivedError("Specifies that the size of the data provided is not what is expected. "
        ...
        case SIMCONNECT_EXCEPTION_DATA_ERROR:
            emit receivedError("Specifies a generic data error. This error is used by the "
        ...
        case SIMCONNECT_EXCEPTION_OPERATION_INVALID_FOR_OBJECT_TYPE:
            emit receivedError("Specifies that the operation requested does not apply to the object "
                               "type, for example trying to set a flight plan on an object that is not "
                               "an aircraft will result in this error.");
            break;
        case SIMCONNECT_EXCEPTION_ILLEGAL_OPERATION:
            emit receivedError("Specifies that the AI operation requested cannot be completed, such as "
        ...
        case SIMCONNECT_EXCEPTION_INVALID_ENUM:
            emit receivedError("Specifies that the member of the enumeration provided was not valid. "
