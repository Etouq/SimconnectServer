...
#include "FlightplanReader/FlightPlanWaypoint.hpp"
...
inline QByteArray convert(const FlightPlanWaypoint &wp)
{
...
template<>
inline FlightPlanWaypoint convert<FlightPlanWaypoint>(QIODevice &data)
{
